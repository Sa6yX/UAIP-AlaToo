        ...
        <section className="mb-4 md:mb-5">
          <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,1fr)_40px] gap-2 md:grid-cols-[minmax(0,1.25fr)_220px_220px_40px] md:items-start md:gap-3">
            <input
              ...
              className="col-span-3 h-10 w-full rounded-[12px] bg-[var(--uaip-surface-2)] px-3.5 text-[0.95rem] text-[var(--uaip-text-primary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.5),0_8px_20px_rgba(17,17,17,0.04)] outline-none transition placeholder:text-[var(--uaip-gray-400)] focus:bg-[var(--uaip-surface-0)] md:col-span-1"
            />
            ...
            <button
              ...
              className="flex h-10 w-10 items-center justify-center self-stretch rounded-[12px] text-[var(--uaip-text-primary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.5),0_8px_20px_rgba(17,17,17,0.04)] transition"
              style={{
